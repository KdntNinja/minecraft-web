...
func DrawDebugOverlay(
	...
	// Colours
	bgColour := color.RGBA{20, 20, 30, 230}
	borderColour := color.RGBA{80, 180, 255, 255}
	accentColour := color.RGBA{80, 255, 180, 255}
	barBgColour := color.RGBA{40, 40, 60, 200}
	fpsBarColour := color.RGBA{80, 255, 80, 255}
	chunkBarColour := color.RGBA{255, 200, 80, 255}
	entityBarColour := color.RGBA{255, 80, 180, 255}
	memBarColour := color.RGBA{120, 120, 255, 255}
	...
	for i := 1; i < len(fpsHistory); i++ {
		...
		ebitenutil.DrawLine(graph, x1, y1, x2, y2, fpsBarColour)
	}
	// Draw max/min lines
	ebitenutil.DrawLine(graph, 0, 0, float64(graphW), 0, accentColour)
	ebitenutil.DrawLine(graph, 0, float64(graphH-1), float64(graphW), float64(graphH-1), accentColour)
	if len(fpsHistory) > 0 {
	...
	for i := 1; i < len(tickTimes); i++ {
		...
		ebitenutil.DrawLine(tickGraph, x1, y1, x2, y2, memBarColour)
	}
	ebitenutil.DrawLine(tickGraph, 0, 0, float64(tickGraphW), 0, accentColour)
	ebitenutil.DrawLine(tickGraph, 0, float64(tickGraphH-1), float64(tickGraphW), float64(tickGraphH-1), accentColour)
